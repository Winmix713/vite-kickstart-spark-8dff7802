...
describe('WidgetRenderer', () => {
  ...
  it('should render TeamStats widget', () => {
    render(<WidgetRenderer type="team_stats" props={{ teamId: 'bayern', season: '2024' }} />);
    expect(screen.getByText(/Team Statistics/i)).toBeDefined();
  });

  it('should render LeagueTable widget', () => {
    render(<WidgetRenderer type="league_table" props={{ league: 'Premier League', season: '2024' }} />);
    expect(screen.getByText(/Premier League/i)).toBeDefined();
  });

  it('should pass props to widget component', () => {
    render(<WidgetRenderer type="team_stats" props={{ teamId: 'real-madrid', season: '2023' }} />);
