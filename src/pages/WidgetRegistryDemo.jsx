    ...
    <div style={{ padding: '40px' }}>
      ...
      <div>
        ...
        <div style={{ 
          ...
          <div>
            <h3 style={{ fontSize: '18px', marginBottom: '12px' }}>TeamStats Widget</h3>
            <WidgetRenderer 
              type="team_stats" 
          ...
          <div>
            <h3 style={{ fontSize: '18px', marginBottom: '12px' }}>LeagueTable Widget</h3>
            <WidgetRenderer 
              type="league_table" 
          ...
          <div>
            <h3 style={{ fontSize: '18px', marginBottom: '12px' }}>Unknown Widget (Error Test)</h3>
            <WidgetRenderer 
