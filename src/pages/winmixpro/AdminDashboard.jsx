            ...
            <Spring className="card card-padded">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div className="bg-gray-800 p-4 rounded-lg">
                        ...
                        <div className="text-sm text-gray-400">Aktív Feladatok</div>
                        <div className="text-sm text-green-400">+3</div>
                    </div>
                    <div className="bg-gray-800 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-white">{stats.modelAccuracy}%</div>
                        <div className="text-sm text-gray-400">Model Pontosság</div>
                    ...
                    <div className="bg-gray-800 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-white">{stats.modelsDeployed}</div>
                        <div className="text-sm text-gray-400">Telepített Modellek</div>
                        <div className="text-sm text-green-400">Stabil</div>
                    </div>
                    <div className="bg-gray-800 p-4 rounded-lg">
                        <div className="text-2xl font-bold text-white">{stats.avgResponseTime}ms</div>
                        <div className="text-sm text-gray-400">Átlag Válaszidő</div>
