...
import { winmixUserMetrics, winmixUsers } from "../../data/users";
...
const Badge = ({ className, variant = "default", children }) => {
    ...
    return (
        <span className={classNames(baseClasses, className)}>
            {children}
        </span>
    );
};
...
const AdminUsers = () => {
  const [roleFilter, setRoleFilter] = usePersistentState(
  ...
  return (
    <>
      <PageHeader
        ...
        metaDescription="Admin, elemző és megfigyelő szerepkörök kezelése, lokális prototípus adatforrással."
      />
      <div className="p-4 space-y-4">
        ...
        <div className="rounded-3xl border border-white/15 bg-white/5 p-4 backdrop-blur">
            ...
            <div className="flex flex-wrap gap-2">
                ...
                <button
                    ...
                    className={classNames("btn btn--sm", {
                        "btn--primary": filter.value === roleFilter,
                        "btn--outline": filter.value !== roleFilter,
                        "bg-emerald-500 text-white hover:bg-emerald-600": filter.value === roleFilter,
                        "bg-white/5 text-white/70 hover:bg-white/10 border-transparent": filter.value !== roleFilter
                    })}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
                <label className="flex items-center gap-2 text-sm text-white/70 cursor-pointer">
                    <Switch id="active-switch" checked={onlyActive} onChange={(e) => setOnlyActive(e.target.checked)} />
                    Csak aktív
                </label>
                <div className="relative">
                    ...
                    <input
                        ...
                        className="field bg-white/5 pl-9 text-white placeholder:text-white/50"
        ...
        <div className="rounded-3xl border border-white/10 bg-black/40 backdrop-blur overflow-x-auto">
            ...
            <tbody className="[&_tr:last-child]:border-0">
                ...
                <tr key={user.id} className="border-b border-white/5 transition-colors hover:bg-white/5 data-[state=selected]:bg-muted">
